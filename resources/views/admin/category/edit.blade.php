            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="category_title" name="Category_title"
                      placeholder="category_title" value="{{$category->Category_title}}">
                  </div>
            </div>
                ...
                <div class="form-checks">
                    <label class="form-check-label mx-3" for="gridCheck">
                      ...
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" name="Status" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="1" @if($category->Status == "Active") checked
                        @endif>
                        <label class="form-check-label" for="inlineRadio1">Active</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" name="Status" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="0"  @if($category->Status == "Inactive") checked
                        @endif>
